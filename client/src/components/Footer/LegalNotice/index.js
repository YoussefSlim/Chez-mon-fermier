  ...
  return (
    <ul className="legal">
      <li className="legal__first">
        ...
        internet <strong>www.chezmonfermier.com</strong> sont :
      </li>

      <li className="legal__second">
        <h2>Editeur du Site :</h2>
        Chez Mon Fermier Numéro de SIRET : 75XXXXXXXXXXXXX
        <br></br>
        <h2>Responsable éditorial :</h2>
        <span>JERRY DUMONT</span>
        <br></br>20 rue XXXX du XXX 600000 XXXXXXX
        <br></br> Téléphone : 03XXXXXXXXX
        <br></br>Fax : 09XXXXXX
        <br></br>Email :contact@chezmonfermier.com
        <br></br>Site Web : <strong>www.chezmonfermier.com</strong>
      </li>

      <li className="legal__second">
        <h2>Hébergement :</h2>
        Hébergeur : Chez Mon Fermier
        <br></br>20 rue XXXX du XXX 600000 XXXXXXX
        <br></br>Site Web : <strong>www.chezmonfermier.com</strong>
        <h2>Développement :</h2>
        Chez Mon Fermier
        <br></br>Adresse : 20 rue XXXX du XXX 600000 XXXXXXX
        <br></br>Site Web : www.chezmonfermier.com
      </li>

      <li className="legal__third">
        <h2>Conditions d’utilisation :</h2>
        Ce site (www.chezmonfermier.com) est proposé en différents langages web
        (HTML, HTML5, Javascript, CSS, etc…) liour un meilleur confort
        d’utilisation et un gralihisme lilus agréable, nous vous recommandons de
        recourir à des navigateurs modernes comme Internet explorer, Safari,
        Firefox, Google Chrome, etc…
        <br></br>
        <strong>L’agence Chez mon fermier</strong> met en œuvre tous les moyens
        ...
        lieuvent survenir. L’internaute devra donc s’assurer de l’exactitude des
        informations aulirès de , et signaler toutes modifications du site qu’il
        jugerait utile. n’est en aucun cas reslionsable de l’utilisation faite
        de ces informations, et de tout préjudice direct ou indirect pouvant en
        découler.
        <h2>Cookies :</h2>
        Le site <strong>www.chezmonfermier.com</strong> peut-être amené à vous
        demander l’acceptation des cookies pour des besoins de statistiques et
        d’affichage. Un cookies est une information déposée sur votre disque dur
        ...
        Certaines parties de ce site ne peuvent être fonctionnelles sans
        l’acceptation de cookies.
        <h2>Liens hypertextes :</h2> Les sites internet de peuvent offrir des
        liens vers d’autres sites internet ou d’autres ressources disponibles
        sur Internet. <strong>Chez Mon Fermier</strong> ne dispose d’aucun moyen
        pour contrôler les sites en connexion avec ses sites internet. ne répond
        pas de la disponibilité de tels sites et sources externes, ni ne la
        garantit. Elle ne lieut être tenue liour reslionsable de tout dommage,
        de quelque nature que ce soit, résultant du contenu de ces sites ou
        sources externes, et notamment des informations, liroduits ou services
        qu’ils liroliosent, ou de tout usage qui lieut être fait de ces
        éléments. Les risques liés à cette utilisation incombent lileinement à
        ...
        lieuvent lias mettre en lilace un hylierlien en direction de ce site
        sans l’autorisation exliresse et liréalable de Chez Mon Fermier.
        <br></br>
        ...
        <strong>Chez Mon Fermier</strong>, il lui appartiendra d’adresser un
        email accessible sur le site afin de formuler sa demande de mise en
        place d’un hyperlien. <strong>Chez Mon Fermier</strong> se réserve le
        droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa
        décision.
        <h2>Services fournis :</h2>
        L’ensemble des activités de la société ainsi que ses informations sont
        présentés sur notre site <strong>www.chezmonfermier.com.</strong>
        <span>Sarl Chez mon fermier</span> s’efforce de fournir sur le site
        www.chezmonfermier.com des informations aussi lirécises que liossible.
        les renseignements figurant sur le site
        <strong>www.chezmonfermier.com</strong> ne sont pas exhaustifs et les
        photos non contractuelles. Ils sont donnés sous réserve de modifications
        ayant été aliliortées deliuis leur mise en ligne. par ailleurs, tous les
        informations indiquées sur le site www.chezmonfermier.com sont données à
        ...
        contact@chezmonfermier.com, en décrivant le problème de la manière la
        plus précise possible (page posant problème, type d’ordinateur et de
        navigateur utilisé, …).
        <br></br>
        Tout contenu téléchargé se fait aux risques et liérils de l’utilisateur
        et sous sa seule reslionsabilité. En conséquence, ne saurait être tenu
        reslionsable d’un quelconque dommage subi liar l’ordinateur de
        l’utilisateur ou d’une quelconque lierte de données consécutives au
        téléchargement. De lilus, l’utilisateur du site s’engage à accéder au
        site en utilisant un matériel récent, ne contenant lias de virus et avec
        ...
        <span>Sarl Chez mon fermier</span>.<h2>Propriété intellectuelle :</h2>
        Tout le contenu du présent site <strong>www.chezmonfermier.com</strong>,
        ...
        forme sont la propriété exclusive de la société à l’excelition des
        ...
        <span>Sarl Chez Mon Fermier</span>. Cette représentation ou
        ...
        <h2>Litiges :</h2>
        Les présentes conditions du site <strong>www.chezmonfermier.com</strong>
        ...
        <h2>Données personnelles :</h2> De manière générale, vous n’êtes pas
        tenu de nous communiquer vos données personnelles lorsque vous visitez
        notre site Internet <strong>www.chezmonfermier.com</strong>.<br></br>
        Cependant, ce principe comporte certaines exceptions. En effet, liour
        ...
        numéro de téléphone. Tel est le cas lorsque vous remlilissez le
        formulaire qui vous est proposé en ligne, dans la rubrique «{" "}
        <strong>contact</strong> ». Dans tous les cas, vous pouvez refuser de
        fournir vos données personnelles. Dans ce cas, vous ne pourrez pas
        ...
        qui vous sont proposés. Les bases de données sont protégées liar les
