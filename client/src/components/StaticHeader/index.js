    ...
    <header className="HomePage_header">
        <nav className="HomePage_menu-top">
            <ul className="HomePage_menu-top_list">
                <li className="logo"><img src="logo-app.png" alt="Logo CHez mon fermier" /></li>
                <li className="search_bar">
                <nav className="navbar navbar-light bg-light">
                    <form className="form-inline">
                        <input className="form-control mr-sm-2" type="search" placeholder="chercher" aria-label="chercher" />
