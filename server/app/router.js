...
router.post('/admin/add/customer', userController.newCustomer);
router.patch('/admin/edit/customer/:id', userController.editCustomer);
router.delete('/admin/delete/customer/:id', userController.deleteCustomer);
